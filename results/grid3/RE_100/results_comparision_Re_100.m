...
fileIDlinear = fopen('results_x_6','r');
formatSpec = '%lf %lf %lf %lf %lf %lf';
sizeA = [6 Inf];
...
title(['Comparision of u-values at various vertical lines for Re=100 with grid3']);
xlabel('u velocity')
ylabel('y')
hold on
...
title(['Comparision of v-values at various vertical lines for Re=100 with grid3']);
xlabel('v velocity')
ylabel('y')
hold on
...
fileID = fopen('grid3_re_100_residue.dat','r');
