...
title(['Comparision of v-values along horizontal line through geometric center of cavity for Re=100 and with square grid 50x50']);
ylabel('v velocity')
xlabel('x')
hold on
...
title(['Comparision of u-values along vertical line through geometric center of cavity for Re=100 and with square grid 50x50']);
xlabel('u velocity')
ylabel('y')
hold on
