...
title(['Comparision of v-values along horizontal line through geometric center of cavity for Re=100 and with square grid 100x100']);
ylabel('v velocity')
xlabel('x')
hold on
...
grid on
hold on
hleg1 = legend('Linear ','TVD','Reference');
...
title(['Comparision of u-values along vertical line through geometric center of cavity for Re=100 and with square grid 100x100']);
xlabel('u velocity')
ylabel('y')
hold on
...
title(['Logorithm of momentum relative residue for RE=100 and square grid 100x100']);
xlabel('Iteration No')
...
title(['Logorithm of momentum absolute residue for RE=100 and square grid 100x100']);
xlabel('Iteration No')
