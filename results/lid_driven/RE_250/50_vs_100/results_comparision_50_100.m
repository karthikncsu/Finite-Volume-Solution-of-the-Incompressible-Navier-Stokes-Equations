...
title(['Comparision of v-values along horizontal line through geometric center of cavity for Re=250']);
ylabel('v velocity')
xlabel('x')
hold on
...
title(['Comparision of u-values along vertical line through geometric center of cavity for Re=250']);
xlabel('u velocity')
ylabel('y')
hold on
...
title(['Logorithm of momentum relative residue for RE=250']);
xlabel('Iteration No')
...
title(['Logorithm of momentum absolute residue for RE=250']);
xlabel('Iteration No')
