...
title(['Comparision of v-values along horizontal line through geometric center of cavity for Re=250 and with square grid 100x100']);
ylabel('v velocity')
xlabel('x')
hold on
...
title(['Comparision of u-values along vertical line through geometric center of cavity for Re=250 and with square grid 100x100']);
xlabel('u velocity')
ylabel('y')
hold on
...
title(['Logorithm of momentum relative residue for RE=250 and square grid 100x100']);
xlabel('Iteration No')
...
title(['Logorithm of momentum absolute residue for RE=250 and square grid 100x100']);
xlabel('Iteration No')
